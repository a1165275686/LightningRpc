package com.rose.lrpc.protocol;

import com.rose.lrpc.loadbalancer.ConsistentHashLoadBalancer;
 ...
 * 负载均衡器测试
 */
public class LocalBalancerTest {
    ...
    public void select() {
        ...
        serviceMetaInfo2.setServiceHost("rose.icu");
